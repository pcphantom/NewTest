...
| Card display | One large icon with a bold outlined number inside it — **not** repeated small symbols |
...
For the reasoning behind any decision here — including rejected ideas, name and card banks, and
the open questions — read `docs/09-conversation-notes.md`. For the client architecture, read
`docs/08-godot-architecture.md`.
